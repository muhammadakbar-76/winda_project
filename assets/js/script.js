...
$("input[type='radio']").on('click',function(){
   if ($("input[name='pilihan']:checked").val() == 'perusahaan') {
       $("button[type='submit']").before(`<div class="form-perusahaan"><div class="form-group">
       <label for="perusahaan">Nama Perusahaan</label>
       <input type="text" name="perusahaan" class="form-control" placeholder="Nama Perusahaan Anda">
     </div>
     <div class="form-group">
        ...
        <div class="form-group">
          <label for="izin">SIUP / NIB</label>
          <input type="text" name="izin" class="form-control" placeholder="Nomor SIUP/NIB">
        </div></div>`);
   }

   else {
       $("div.form-perusahaan").remove();
   }
})
